...
echo "Deploying execution environments."
mkdir -p /home/amaral/Heist
rm -rf /home/amaral/Heist/*
cp generalRepository.zip /home/amaral/Heist
cp assaultParty.zip /home/amaral/Heist
cp concentrationSite.zip /home/amaral/Heist
cp controlSite.zip /home/amaral/Heist
cp museum.zip /home/amaral/Heist
cp ordinaryThieves.zip /home/amaral/Heist
cp masterThief.zip /home/amaral/Heist
cp genclass.jar /home/amaral/Heist
...
cd /home/amaral/Heist

echo "Decompressing execution environments."

unzip -q generalRepository.zip
unzip -q assaultParty.zip
unzip -q concentrationSite.zip
unzip -q controlSite.zip
unzip -q museum.zip
unzip -q ordinaryThieves.zip
unzip -q masterThief.zip
