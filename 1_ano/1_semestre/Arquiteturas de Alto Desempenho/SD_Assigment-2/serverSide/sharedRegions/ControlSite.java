...
public class ControlSite {
    ...
    public ControlSite(GeneralRepoStub generalRepo) {
    ...
    public synchronized void startOfOperation() {
        ((ControlSiteClientProxy) Thread.currentThread()).setMasterThiefState(MasterThiefStates.DECIDING_WHAT_TO_DO);
    }
    ...
    public synchronized void handACanvas(boolean hasCanvas, int assaultPartyId, int roomId) {
        ControlSiteClientProxy currentThief = (ControlSiteClientProxy) Thread.currentThread();
        int thiefId = currentThief.getOrdinaryThiefId();
        ...
        currentThief.setOrdinaryThiefState(OrdinaryThiefStates.WAITING_TO_HAND_A_CANVAS);
    ...
    public synchronized void takeARest() {
        ...
        ((ControlSiteClientProxy) Thread.currentThread()).setMasterThiefState(MasterThiefStates.WAITING_FOR_GROUP_ARRIVAL);
    ...
    /**
     * Operation to shut down the Control Site
     */

     public synchronized void shutdown(){
        ServerControlSite.waitConnection = false;
    }
