...
public class GeneralRepo {
    ...
    /**
     * Reporting the initial distance to rooms
     */

    public synchronized void reportInitialDistances(int[] distanceToRoom) {
    ...
    public synchronized void reportRoomNumCanvas(int[] canvasInRoom) {
    ...
    public synchronized void reportThievesAgility(int[] agility) {
    ...
    public synchronized void setOrdinaryThiefMaxDisplacement(int maxDisplacement[]) {
    ...
    public synchronized void setDistanceToRoom(int distanceToRoom[]) {
        this.distanceToRoom = distanceToRoom;
    }
    ...
    public synchronized void setPaintingsInRoom(int paintingsInRoom[]) {
