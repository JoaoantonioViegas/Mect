...
public class ServerControlSite{
    ...
    public static void main(String[] args) {
        ControlSite controlSite;                                          // controlSite object
        ControlSiteInterface controlSiteInter;                            // interface to the controlSite
        ...
        controlSite = new ControlSite(repoStub);
        controlSiteInter = new ControlSiteInterface(controlSite);
        ...
        while (waitConnection)
            try{ 
                sconi = scon.accept();
                cliProxy = new ControlSiteClientProxy(sconi, controlSiteInter);
                cliProxy.start();
