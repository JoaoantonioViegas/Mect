...
sshpass -f password scp sd203@l040101-ws06.ua.pt:Heist/generalRepository/log.txt /home/amaral/

echo "Downloading total.txt from the Client node."
sshpass -f password scp sd203@l040101-ws10.ua.pt:Heist/ordinaryThieves/total.txt /home/amaral/
